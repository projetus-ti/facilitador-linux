...
if [ "$setor" = "Contábil" ]; then ## Contabil
    ...
    TRUE "SPED ECD" "Versão 8.0.3" \
    FALSE "SPED ECF" "Versão 7.0.2" \
  ...
  acao=$(zenity  --list  --text "Selecione o programa desejado:" \
    ...
    FALSE "EFD Contribuições" "Versão 4.1.1" \
    ...
    FALSE "SPED ICMS IPI" "Versão 2.7.0");  
  ...
  acao=$(zenity  --list  --text "Selecione o programa desejado:" \
    ...
    FALSE "DIRF" "Versão 2021-1.0"\
    FALSE "GDRAIS" "Versão 2020.1.1.0"\
    FALSE "GRRF" "Versão ICP-20200128" \
    FALSE "SEFIP" "Versão 8.40-24-12-2020" \
