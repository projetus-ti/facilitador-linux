...
if [ "$acao" = "DCTF" ]; then
  ...
  rm -Rf DCTF*
  download "http://receita.economia.gov.br/orientacao/tributaria/declaracoes-e-demonstrativos/dctf-declaracao-de-debitos-e-creditos-tributarios-federais/programa-gerador-da-declaracao-pgd/DCTFMensalV3.5b.exe" "$cache_path/dctf.exe"
...
if [ "$acao" = "EFD Contribuições" ]; then
  download "http://www.receita.fazenda.gov.br/publico/programas/SpedPisCofinsPVA/EFDContribuicoes_linux_x64-3.1.4.jar" "$cache_path/EFDContribuicoes.jar"
