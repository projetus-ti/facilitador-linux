...
if [ "$acao" = "EFD Contribuições" ]; then
  ...
  download "https://www.receita.fazenda.gov.br/publico/programas/SpedPisCofinsPVA/EFDContribuicoes_linux_x64-5.0.1.jar" "$cache_path/EFDContribuicoes.jar"
...
if [ "$acao" = "SPED ICMS IPI" ]; then
  download "https://www.receita.fazenda.gov.br/publico/programas/Sped/SpedFiscal/PVA_EFD_linux-2.7.2_x64.jar" "$cache_path/PVA_EFD.jar"
