...
if ! (flatpak list | grep WineZGUI); then
    ...
    executar "flatpak --user -y install flathub org.winehq.Wine/x86_64/stable-22.08 -y"
    ...
    executar "flatpak --user install flatpak-winezgui_0.97.12_20230522.flatpak -y"
fi
