...
if [ "$acao" = "SPED ECD" ]; then
  download "https://servicos.receita.fazenda.gov.br/publico/programas/Sped/SpedContabil/SPEDContabil_linux_x64-9.0.4.jar" "$cache_path/SPEDContabil.jar"
...
if [ "$acao" = "SPED ECF" ]; then
  download "https://servicos.receita.fazenda.gov.br/publico/programas/Sped/ECF/SpedEcf_linux_x64-8.0.2.jar" "$cache_path/SpedEcf.jar"
