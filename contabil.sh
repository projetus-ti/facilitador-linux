...
if [ "$acao" = "SPED ECF" ]; then
  download "http://www.receita.fazenda.gov.br/publico/programas/Sped/ECF/SpedEcf_linux_x64-6.0.5.jar" "$cache_path/SpedEcf.jar"
  ...
  user_install "SPED%20ECF%20v6.0.5"
