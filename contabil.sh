...
if [ "$acao" = "SPED ECD" ]; then            
  ...
  download "https://servicos.receita.fazenda.gov.br/publico/programas/Sped/SpedContabil/SpedContabil_linux_x86_64-10.4.1.sh" "$cache_path/SPEDContabil.sh"
...
if [ "$acao" = "SPED ECF" ]; then 
  ...
  download "https://servicos.receita.fazenda.gov.br/publico/programas/Sped/ECF/SpedECF_linux_x86_64-12.2.0.sh" "$cache_path/SpedEcf.sh"
